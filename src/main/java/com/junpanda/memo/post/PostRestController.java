package com.junpanda.memo.post;
...
import com.junpanda.memo.post.bo.PostBO;
...
public class PostRestController {
	...
	/*
	 * @PostMapping("/create") public Map<String, String> create(
	 * 
	 ...
	 * 
	 * //현재 로그인된 사용자의 user table id(pk) int userId =
